...
# 7 "configuraTemperatura.c" 2
# 1 "./atraso.h" 1



    void atraso_ms(unsigned int t);
# 8 "configuraTemperatura.c" 2
# 1 "./lcd.h" 1
# 23 "./lcd.h"
...
# 9 "configuraTemperatura.c" 2
# 1 "./adc.h" 1
# 27 "./adc.h"
void adc_init(void);

unsigned int adc_amostra(unsigned char canal);
# 10 "configuraTemperatura.c" 2
# 1 "./pwm.h" 1
# 23 "./pwm.h"
 ...
 void pwmInit(void);
# 11 "configuraTemperatura.c" 2
# 1 "./itoa.h" 1
# 26 "./itoa.h"
void itoa(unsigned int val, char* str );
# 12 "configuraTemperatura.c" 2
# 1 "./configuraTemperatura.h" 1
