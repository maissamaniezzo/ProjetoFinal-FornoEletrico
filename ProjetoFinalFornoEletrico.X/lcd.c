...
#define EN PIN_E1
#define RS PIN_E2
#define L0 0x80  // Cursor na primeira linha
#define L1 0xC0  // Cursor na segunda linha
...
void lcdPosition(unsigned char linha, unsigned char coluna){
    ...
    if(linha == 0) comando = L0 + coluna;  // Vai para a linha 0
    if(linha == 1) comando = L1 + coluna;  // Vai para a linha 1
